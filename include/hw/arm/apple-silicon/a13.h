...
typedef struct AppleA13State {
    ...
    A13_CPREG_VAR_DEF(ARM64_REG_MMU_ERR_STS);
    ...
    A13_CPREG_VAR_DEF(ARM64_REG_LLC_RAM_CONFIG);
    ...
    A13_CPREG_VAR_DEF(ARM64_REG_CPU_OVRD);
    A13_CPREG_VAR_DEF(ARM64_REG_ACC_OVRD);
